...
{
    public static class DynamicSqlResository
    {
        public static System.Collections.IEnumerable DynamicSqlQuery(Database database, string sql, params object[] parameters)
        {
