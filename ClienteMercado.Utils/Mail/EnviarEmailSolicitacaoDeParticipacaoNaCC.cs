...
{
    public class EnviarEmailSolicitacaoDeParticipacaoNaCC
    {
        //==================================================================
        /*
        ...
        */
        ...
        public bool EnviandoEmailSolicitandoParticipacaoNaCC(string email1_EmpresaAdm, string email2_EmpresaAdm, string email1_UsuarioContato, string email2_UsuarioContato,
            string assuntoEmail, string corpoEmail)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(email1_EmpresaAdm))
                {
                    mail.To.Add(email1_EmpresaAdm);
                }

                if (!string.IsNullOrEmpty(email2_EmpresaAdm))
                {
                    MailAddress copy = new MailAddress(email2_EmpresaAdm);
                    mail.CC.Add(copy);
                }
