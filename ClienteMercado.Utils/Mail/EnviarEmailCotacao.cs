...
{
    public class EnviarEmailCotacao
    {
            ...
            string _nomeCentralDeCompras)
        {
            ...
            mensagem = @"<html><body><tr><td><table width='80%' align='center' bgcolor='#E8E8E8'><tr><td><img src='cid:Imagem1' /></td>" +
                        "<tr><td align='center'><h2><b>AVISO de COTAÇÃO</b></h2></td></tr><tr><td><br>&nbsp;&nbsp;Sr(a) " + _usuario + ", <br><br>" +
                        "&nbsp;&nbsp;Você tem uma COTAÇÃO a ser respondida na plataforma ClienteMercado.com, enviada pela Central de Compras:</td></tr><tr><td align='center'>" +
