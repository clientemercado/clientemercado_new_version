...
{
    public class cliente_mercadoContext : DbContext
    {
        public cliente_mercadoContext() : base("Name=cliente_mercadoContext")
        {
            ...
            //this.Database.CommandTimeout = 180; // Evitar TimeOut

            Database.SetInitializer<cliente_mercadoContext>(null);
        }
        ...
        public DbSet<pedido_central_compras> pedido_central_compras { get; set; }
        ...
        public DbSet<empresas_solicitacao_participacao_central_de_compras> empresas_solicitacao_participacao_central_de_compras { get; set; }
        ...
        public DbSet<EMPRESA_FORNECEDOR> empresa_fornecedor { get; set; }
        public DbSet<USUARIO_FORNECEDOR> usuario_fornecedor { get; set; }
        public DbSet<USUARIO_COMPRADOR> usuario_comprador { get; set; }
        public DbSet<PRODUTOS_FORNECEDOR> produtos_fornecedor { get; set; }
        public DbSet<COTACAO_PRODUTOS> cotacao_produtos { get; set; }
        public DbSet<PRODUTOS_COTACAO_PEDIDO> produtos_cotacao_pedido { get; set; }
