...
{
    public class CotacoesEnviadasController : Controller
    {
        //
        // GET: /Company/CotacoesEnviadas/
        ...
        public ActionResult Index()
        {
            try
            {
                if (Session["IdUsuarioLogado"] != null)
                {
                    ...
                    ViewBag.ondeEstouAgora = "Cotações Enviadas";
        ...
        public ActionResult VisualizarCotacaoEnviada()
        {
            try
            {
                if (Session["IdUsuarioLogado"] != null)
                {
                    ...
                    //VIEWBAGS
                    ViewBag.dataHoje = diaDaSemana + ", " + diaDoMes + " de " + mesAtual + " de " + anoAtual;
                    ViewBag.ondeEstouAgora = "Cotações Enviadas > Visualizar Cotação Enviada";
